...
public class ConnectedHttpCLient {
    ...
    /**
     * Obtenir la list des noms de joueur qui sont connectés
     * **/
    ...
    /**
     * @param token
     * @param userInfo = prend le level du joueur
     *  Pour qu'un joueur rentre dans la "salle d'attente et de se faire défier ou défier"
     * **/
